                            ...
                            <ul class="stat-boxes2">
                                ...
                                <li>
                                    <div class="left peity_line_good">
                                        <span>
                                            <span style="display: none;">12,6,9,13,14,10,17</span>
                                            <canvas width="50" height="24"></canvas>
                                        </span>+60%</div>
                        ...
                        <ul class="recent-posts">
                            <li>
                                <div class="user-thumb"> 
                                    <img width="40" height="40" alt="User" src="<c:url value='/img/demo/av1.jpg' />"> 
                                </div>
                            ...
                            <li>
                                <div class="user-thumb"> <img width="40" height="40" alt="User" src="<c:url value='/img/demo/av2.jpg' />"> </div>
                                <div class="article-post"> <span class="user-info"> By: john Deo / Date: 2 Aug 2012 / Time:09:27 AM </span>
                                    <p><a href="#">This is a much longer one that will go on for a few lines.It has multiple paragraphs and is full of waffle to pad out the comment.</a> </p>
                                </div>
                            </li>
                            <li>
                                <div class="user-thumb"> <img width="40" height="40" alt="User" src="<c:url value='/img/demo/av4.jpg' />"> </div>
                                <div class="article-post"> <span class="user-info"> By: john Deo / Date: 2 Aug 2012 / Time:09:27 AM </span>
                    ...
                    <div class="widget-content nopadding updates">
                        ...
                        <div class="new-update clearfix"> 
                            ...
                            <span class="update-notice"> 
                                <a title="" href="#">
                                    <strong>Congratulation Maruti, Happy Birthday </strong>
                                </a>
                        ...
                        <div class="new-update clearfix"> 
                            ...
                            <span class="update-alert">
                                <a title="" href="#">
                                    <strong>Maruti is a Responsive Admin theme</strong>
                                </a> 
                        ...
                        <div class="new-update clearfix"> 
                            ...
                            <span class="update-notice"> 
                                <a title="" href="#">
                                    <strong>I am alwayse here if you have any question</strong>
                                </a> 
                            ...
                            <div class="panel-content nopadding">
                                <ul class="contact-list">
                                    <li id="user-Sunil" class="online">
                                        <a href=""><img alt="" src="<c:url value='/img/demo/av1.jpg' />" /> <span>Sunil</span></a>
                                    </li>
                                    <li id="user-Laukik">
                                        <a href=""><img alt="" src="<c:url value='/img/demo/av2.jpg' />" /> <span>Laukik</span></a>
                                    </li>
                                    <li id="user-vijay" class="online new">
                                        <a href=""><img alt="" src="<c:url value='/img/demo/av3.jpg' />" /> <span>Vijay</span></a>
                                        <span class="msg-count badge badge-info">3</span>
                                    </li>
                                    <li id="user-Jignesh" class="online">
                                        <a href=""><img alt="" src="<c:url value='/img/demo/av4.jpg' />" /> <span>Jignesh</span></a>
                                    </li>
                                    <li id="user-Malay" class="online">
                                        <a href=""><img alt="" src="<c:url value='/img/demo/av5.jpg' />" /> <span>Malay</span></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="widget-box">
                    ...
                    <div class="widget-content tab-content">
                        <div id="tab1" class="tab-pane active">
                            ...
                            <img src="<c:url value='/img/demo/demo-image1.jpg' />" alt="demo-image"/>
                        </div>
                        <div id="tab2" class="tab-pane"> 
                            <img src="<c:url value='/img/demo/demo-image2.jpg' />" alt="demo-image"/>
                            <p>And is full of waffle to It has multiple paragraphs and is full of waffle to pad out the comment. Usually, you just wish these sorts of comments would come to an end.multiple paragraphs and is full of waffle to pad out the comment.</p>
                        </div>
                        <div id="tab3" class="tab-pane">
                            <p>And is full of waffle to It has multiple paragraphs and is full of waffle to pad out the comment. Usually, you just wish these sorts of comments would come to an end.multiple paragraphs and is full of waffle to pad out the comment. </p>
                            <img src="<c:url value='/img/demo/demo-image3.jpg' />" alt="demo-image"/>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding fix_hgt">
                        <ul class="recent-posts">
                            ...
                            <li>
                                <div class="user-thumb">
                                    <img width="40" height="40" alt="User" src="<c:url value='/img/demo/av2.jpg' />"> 
                                </div>
                                <div class="article-post"> 
                                    <span class="user-info">John Deo</span>
                                    <p>Web Desginer &amp; creative Front end developer</p>
                            ...
                            <li>
                                <div class="user-thumb">
                                    <img width="40" height="40" alt="User" src="<c:url value='/img/demo/av4.jpg' />"> </div>
                                <div class="article-post"> 
                                    <span class="user-info">John Deo</span>
                                    <p>Web Desginer &amp; creative Front end developer</p>
                                </div>
